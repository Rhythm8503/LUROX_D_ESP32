...
#define BUILD 2  // 1 Azami, 2 Ene, 3 Wim, 4 Ares
...
#define SERVICE_UUID "72260ae0-e563-49b1-bc9f-647223a1eeef"  // UART ID
...
uint16_t WristPA[3] = {90, 0, 0 };   // Wrist Pitch
uint16_t ElbowPA[3] = {135, 0, 0 };  // Elbow Pitch
uint16_t WristRA[3] = {135, 135, 0 };  // Wrist Roll 
uint16_t ArmRA[3] =   {135, 0, 0 };  // Shoulder Roll
uint16_t ArmPA[3] =   {122, 0, 0 };  // Shoulder Pitch
uint16_t ArmYA[3] =   {135, 135, 0 };  // Shoulder Yaw

uint16_t ThumbRA[2] =  {0, 0};       // Thumb 
uint16_t IndexRA[2] =  {0, 0};       // Index
uint16_t MiddleRA[2] = {0, 0};       // Middle
uint16_t RingRA[2] =   {0, 0};       // Ring
uint16_t PinkyRA[2] =  {0, 0};       // Pinky
...
uint16_t CameraL[3] = {0, 0, 0};  /* Desired XYZ from Inverse Kinematics */
uint16_t Obj_Vect[3] = {0, 0, 0}; /* Vector Pointing to Object */
uint16_t Arm_Pos[3] = {0, 0, 0}; /* Current XYZ from Forward Kinematics */

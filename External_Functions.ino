...
void Standby() {  // Wander
  ...
  ArmPA[0] = random(135, 145);    //Shoulder Pitch
  ArmRA[0] = random(132, 138);    //Shoulder Roll
  ArmYA[0] = random(120, 150);     //Shoulder Yaw
  ElbowPA[0] = random(135, 215);  //Elbow Pitch
  WristPA[0] = random(90, 110);   //Wrist Pitch
  WristRA[0] = random(120, 150);   //Wrist Roll
}

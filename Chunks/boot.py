...
# Register pins
fm.register(DAT_PIN, fm.fpioa.GPIOHS24, force=True)
fm.register(CLK_PIN, fm.fpioa.GPIOHS25, force=True)
...
#NOTES:
# It seems that Data is pin 25, and CLK is 24. For Azami only 2 LEDs want to work right now.
...
while True:
    ...
    color = [255, 100, 0]  # Red color
    set_led_ring(brightness_values, color)
    time.sleep_ms(500);
    brightness_values = [175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175]
    color = [255, 0, 0]  # Red color
    set_led_ring(brightness_values, color)
    time.sleep_ms(500);
    brightness_values = [105, 105, 105, 105, 105, 105, 105, 105, 105, 105, 105, 105]
    color = [255, 0, 0]  # Red color
    set_led_ring(brightness_values, color)
